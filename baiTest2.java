...
public class baiTest2 {
    public static void main(String[] args) {
        try (
                Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/cafenew ","root","");
            ...
            do {
                ...
                switch (y) {
                    case 1:
                        ...
                        String check1 = "select * from Drink WHERE cafenew = '"+ name1 +"';";
                    ...
                    case 2:
                        ...
                        String check2 = "select * from Drink WHERE cafenew = '"+ name2 +"';";
                    ...
                    case 4:
                        ...
                        String delete4 = "DELETE FROM Drink WHERE cafenew ='"+name4+"';";
